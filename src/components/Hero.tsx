        ...
        <div className="text-center">
          ...
          >
            ...
            <motion.button
              ...
              className="px-8 py-3 bg-transparent border-2 border-cyan-400 text-cyan-400 rounded-lg hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300"
            >
              Get In Touch
            </motion.button>
          </motion.div>
